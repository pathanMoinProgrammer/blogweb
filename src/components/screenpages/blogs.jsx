...
export async function BlogSection({ params }) {
  const locale = params.locale; // Correctly extract locale
              ...
              <div>
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <Link href={`/${locale}/blogpost/${blog.slug}`}>
                    <Button
                      className="mt-4 h-auto text-sm font-medium text-indigo-600 dark:text-indigo-600 hover:text-purple-500/90 dark:hover:text-purple-600 max-w-[40%] hover:bg-white/5 transition-transform hover:scale-110 self-center cursor-pointer bg-white/80 px-[20px]"
                    >
                      Read more →
                    </Button>
                  </Link>
