...
//   return (
//     <section className="py-16 px-4 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 min-h-screen">
...
//                     <h2 className="text-xl font-bold text-gray-900 dark:text-white line-clamp-3 hover:text-blue-600 dark:hover:text-blue-400 transition-colors cursor-pointer leading-tight">
//                       {blog.title}
//                     </h2>

//                     <p
//                       className="mt-3 text-gray-600 dark:text-gray-300 text-sm md:text-base 
//                                  line-clamp-1 sm:line-clamp-2 lg:line-clamp-2
//                                  flex-grow"
//                     >
...
//                       <button
//                         className="inline-block bg-blue-600 text-white font-semibold py-2.5 px-5 rounded-lg 
//                       hover:bg-blue-700 transition-colors text-sm cursor-pointer"
//                       >
//                         {t.readmore || 'Read More'} ➡️
//                       </button>
//                     </div>
//                   </div>
//                 </Link>
//                 <div className="border-t bottom-0 border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50 py-3 px-6 w-full">
//                   <Reactions
//                     slug={blog.slug}
//                     postid={blog.id}
//                     locale={locale}
          ...
          {blogs?.map((blog, index) => (
            ...
            >
              <div className="bg-white dark:bg-gray-800 rounded-xl flex flex-col h-full">
                ...
                <Link href={`/${locale}/blogpost/${blog.slug}`} className="flex flex-col flex-grow">
                  <div className="relative h-48 w-full overflow-hidden">
                    <img
                      src={blog.imgUrl}
                      alt={blog.title}
