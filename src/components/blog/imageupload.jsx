          ...
          {uploading ? (
            ...
            <div className="flex flex-col items-center space-y-3 w-full">
              <img
                src={imgUrl}
                alt="Uploaded"
                className="max-h-96 w-full object-contain rounded-lg border border-gray-300"
              />
            ...
            <div className="flex flex-col items-center space-y-2">
              ...
              <p className="text-gray-600 dark:text-gray-300 font-medium">Click or drag image</p>
              <p className="text-xs text-gray-500 dark:text-gray-400">PNG, JPG, WEBP (max 10 MB)</p>
            </div>
          )}
        </div>
        {errorMsg && (
          <p className="text-sm text-red-500 mt-3 px-1">{errorMsg}</p>
        )}
      </div>
    </div>
  );
